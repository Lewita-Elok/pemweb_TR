...
<!-- HERO SECTION -->
<section id="hero" class="w-full h-[600px] bg-[url('images/bg.jpg')] bg-no-repeat bg-cover bg-center relative">
    <div class="absolute inset-0 text-white flex items-center justify-center flex-col text-center px-4">
        ...
        <button
            class="mt-8 md:mt-12 rounded-lg border border-red-600 px-6 md:px-10 py-2 md:py-3 bg-red-600 shadow-xl hover:bg-red-700 hover:border-red-700 transition-all">Beli
            Sekarang</button>
    </div>
</section>
...
<!-- Produk Boquet -->
<section class="mt-16 px-4 md:px-48 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="max-w-full md:max-w-[350px] border group rounded-xl transition-all duration-300">
            <div class="relative">
                ...
                <a href="./views/detail-produk-page.php?id=<?= $produk['IdProduk'] ?>">
                    <div
                        class="absolute top-0 right-0 bg-[rgba(0,0,0,0.6)] p-3 rounded-lg m-4 invisible group-hover:visible hover:cursor-pointer">
            ...
            <div class="px-5 pt-2 pb-5">
                ...
                <p class="mt-5 text-slate-500">Buket pilihan sesuai dengan gambar. Silahkan tekan icon diatas untuk melihat
                    secara detail</p>
                <div class="flex items-center justify-between mt-5">
                    ...
                    <?php if (isset($_SESSION['nama']) && isset($_SESSION['role']) == 'customer'): ?>
                        <a href="./views/cart-page.php?action=add&IdProduk=<?= $produk['IdProduk'] ?>">
                            <svg class="text-3xl" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                viewBox="0 0 20 20">
                                <path fill="currentColor"
